...
export const POETIC_ORACLES = [
  {
    title: '湖上风来 · 气象自新',
    content: '今日运势如春日苏堤。适合开启新计划，智能之风助你事半功倍。',
    spot: '苏堤春晓',
    advice: '宜：创新、拓展、漫步湖畔。忌：墨守成规。'
  },
  {
    title: '风荷摇曳 · 灵感汇聚',
    content: '今日思维敏捷，如夏日风荷。多倾听他人想法，将碰撞出数字灵感。',
    spot: '曲院风荷',
    advice: '宜：团队协作、创意头脑风暴。忌：急躁冒进。'
  },
  {
    title: '三潭映月 · 虚实相生',
    content: '今天宜沉思、自省。在古典积淀中融入现代洞察，必能看清前进方向。',
    spot: '三潭印月',
    advice: '宜：复盘、深度思考、数字加密。忌：过度张扬。'
  },
  {
    title: '断桥瑞雪 · 蓄势待发',
    content: '红梅傲雪，蓄积力量。当前正是打好基础的时期，静待春风拂来。',
    spot: '断桥残雪',
    advice: '宜：修身、查漏补缺、系统架构设计。忌：盲目跟风。'
  },
  {
    title: '弄潮钱塘 · 智领未来',
    content: '大潮奔涌，勇立潮头。你有极大的创造力和破局之势，尽情施展才华吧。',
    spot: '钱江新城',
    advice: '宜：发布新品、挑战难关、部署大模型。忌：畏缩不前。'
  }
];
